...
import WaveAni from '@/components/board/WaveAni';
...
export default async function Board() {
  ...
  return (
    <div className="px-6 xl:px-14 py-6 md:py-8">
      <WriteBtn />
      <div
        className={`grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5 xl:gap-10 ${SCDream.className}`}
      >
        {posts.map((post) => (
          <div
            key={post.id}

  ...
  return (
    <ModalPortal>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/35">
        <div
          className="w-full max-w-[28rem] rounded-xl bg-white px-6 pt-6 pb-5 shadow-xl"
          onClick={(e) => e.stopPropagation()}
        >
          <div className="mb-5 flex items-center justify-start">
            <h2 className="text-[1.1rem] font-semibold">글 삭제</h2>
          </div>
          ...
          <form onSubmit={onSubmit}>
            <div className="mb-1 flex flex-col gap-1">
              <div className="flex items-center justify-between gap-1">
                ...
                {errorMessage && (
                  <p className="text-[0.8rem] text-red-500">{errorMessage}</p>
                )}
              </div>
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                className="rounded-md bg-red-500 px-4 py-2 text-[0.9rem] text-white hover:bg-red-600 disabled:opacity-50"
              >
                삭제
              </button>
            </div>
